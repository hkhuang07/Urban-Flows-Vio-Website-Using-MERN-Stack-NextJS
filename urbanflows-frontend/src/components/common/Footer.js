  ...
  return (
    <footer className="bg-[#000624] text-[#F0F8FF] pt-12 pb-7 border border-[#000624]">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mt-8 text-center text-sm space-y-5 md:space-y-2">
          ...
          <div className="md:text-right text-gray-100">
