  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          onClick={handleAdd}
          className="bg-[#00BFFF] text-white py-2 px-6 rounded-full font-semibold hover:bg-opacity-80 transition-colors duration-300"
        >
          Add New Category
        </button>
      </div>
      ...
      <div className="overflow-x-auto rounded-lg shadow-md">
        <table className="min-w-full table-auto">
          <thead>
            <tr className="bg-[#000022] text-white">
